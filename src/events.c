...
const static struct eventmap_s eventmap[]={
  ...
  EM(PAPI_L1_DCH,   "L1 data Cache Hit"),
  EM(PAPI_L2_DCH,   "L2 data Cache Hit"),
  EM(PAPI_L1_DCA,   "L1 data Cache Access"),
  EM(PAPI_L2_DCA,   "L2 data Cache Access"),
  EM(PAPI_L3_DCA,   "L3 data Cache Access"),
  EM(PAPI_L1_DCR,   "L1 data Cache Read"),
  EM(PAPI_L2_DCR,   "L2 data Cache Read"),
  EM(PAPI_L3_DCR,   "L3 data Cache Read"),
  EM(PAPI_L1_DCW,   "L1 data Cache Write"),
  EM(PAPI_L2_DCW,   "L2 data Cache Write"),
  EM(PAPI_L3_DCW,   "L3 data Cache Write"),
